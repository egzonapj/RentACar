...
if(isset($_POST['shtorezervim'])){
    shtoRezervim($_POST['klienti'],$_POST['automjeti'],$_POST['datamarrjes'],$_POST['datakthimit']);
}
if(isset($_POST['modifikorezervim'])){
    modifikoRezervim($rezervimiid,$_POST['klienti'],$_POST['automjeti'],$_POST['datamarrjes'],$_POST['datakthimit']);
}
...
<section class="section-shto-modifiko container">
    ...
    <div class="forma">
        ...
        <br>
        <form method="POST" id="rezervimet">
